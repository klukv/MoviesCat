...
def main() -> None:
    ...
    # В Windows-консоли часто не поддерживаются символы псевдографики.
    # Используем ASCII-разделитель, чтобы не падать с UnicodeEncodeError.
    print(f"  {'-'*38}")
    ...
    print(f"{'='*42}")
    print("! Метрики завышены из-за смещения MovieLens 1M.")
